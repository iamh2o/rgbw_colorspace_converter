...
def color_whirler(color, codes=False):
    ...
    while rolling:
        ...
        color.hsv_h = color.hsv_h + num_increments
        color.hsv_s = color.hsv_s + num_increments
        color.hsv_v = color.hsv_h + num_increments
