...
def display_color(color, show_values=None, fh=None):
...
def color_whirler(color, codes=False):
    ...
    while rolling:
        ...
        color.hsv_h = color.hsv_h + b
        color.hsv_s = color.hsv_s + b
        color.hsv_v = color.hsv_h - b
...
def color_spinner(color, codes=False, fh=None):
